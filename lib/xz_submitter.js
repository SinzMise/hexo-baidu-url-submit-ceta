...
module.exports = function(args) {
    ...
    var xz_appid = process.env.BAIDU_URL_SUBMIT_XZ_APPID || config.baidu_url_submit.xz_appid;
    var xz_token = process.env.BAIDU_URL_SUBMIT_XZ_TOKEN || config.baidu_url_submit.xz_token;
    var xz_count = process.env.BAIDU_URL_SUBMIT_XZ_COUNT || config.baidu_url_submit.xz_count;
